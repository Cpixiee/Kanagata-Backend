<!-- File: resources/ledger.blade.php -->
<!-- Halaman untuk menampilkan data ledger/buku besar -->
<!DOCTYPE html>
<html lang="en">
...
<body class="font-poppins">
    ...
    <div class="dataTables_scroll">
        <table id="ledger-table" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody class="text-center">
                ...
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4">{{ $ledger->project->coa ?? 'N/A' }}</td>
                    <td class="px-6 py-4">{{ $ledger->sub_budget }}</td>
                    <td class="px-6 py-4">{{ $ledger->recipient }}</td>
                    <td class="px-6 py-4">{{ $ledger->transaction_date }}</td>
                    <td class="px-6 py-4">{{ $ledger->month_year }}</td>
                    <td class="px-6 py-4">{{ $ledger->status }}</td>
                    ...
                    <td class="px-6 py-4 flex justify-center">
                        ...
                        <form action="{{ route('ledgers.destroy', $ledger->id) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
