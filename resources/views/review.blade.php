...
<head>
    ...
    <title>Kanagata - Review Requests</title>
...
<body class="font-poppins bg-gray-50">
    <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <div>
                    <h1 class="self-center text-xl sm:text-2xl font-semibold dark:text-white">Review</h1>
                </div>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-14">
            ...
            <div class="grid grid-cols-4 gap-4 mb-8">
                <div class="p-4 bg-white rounded-lg shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-sm font-medium text-gray-600">Total Review</h2>
                            <p class="text-2xl font-semibold text-blue-500">{{ $reviewRequests->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 bg-white rounded-lg shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-sm font-medium text-gray-600">Approved</h2>
                            <p class="text-2xl font-semibold text-green-500">{{ $reviewRequests->where('status', 'approved')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 bg-white rounded-lg shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-yellow-500">{{ $reviewRequests->where('status', 'pending')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 bg-white rounded-lg shadow">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-red-500">{{ $reviewRequests->where('status', 'rejected')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4 mb-6">
                <div class="flex-1">
                    <select id="category-filter" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                ...
                <div class="flex-1">
                    <input type="search" id="search-input" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Search by name, email, COA, customer, activity...">
                </div>
                <div>
                    <button id="clear-filters" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        Clear Filters
                    </button>
                </div>
            </div>
            ...
            <div id="review-list" class="space-y-4">
                @include('partials.review-list', ['reviewRequests' => $reviewRequests])
            </div>
        </div>
    </div>
    ...
    <div id="details-modal" tabindex="-1" aria-hidden="true" 
        ...
        class="hidden fixed inset-0 z-50 items-center justify-center overflow-y-auto bg-gray-900 bg-opacity-50">
        <div class="relative p-4 w-full max-w-6xl max-h-full">
            <div class="relative bg-white rounded-xl shadow-2xl dark:bg-gray-800">
                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200 rounded-t-xl bg-gradient-to-r from-blue-50 to-indigo-50">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Complete information about this review request</p>
                        </div>
                    </div>
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center transition-colors duration-200" data-modal-hide="details-modal">
                ...
                <!-- Modal Footer -->
                <div class="flex items-center justify-end p-6 border-t border-gray-200 rounded-b-xl bg-gray-50">
                    <button type="button" class="px-6 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200" data-modal-hide="details-modal">
                        Close
                    </button>
                </div>
            </div>
