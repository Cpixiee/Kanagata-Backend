...
function updateTableData(data) {
    ...
    animateValue('this-month-cost-operation', data.this_month.cost_operation);
    animateValue('this-month-profit-loss', data.this_month.profit_loss);
    ...
    animateValue('summary-cost-operation', data.summary.cost_operation);
    animateValue('summary-profit-loss', data.summary.profit_loss);
    ...
    animateValue('average-cost-operation', data.average.cost_operation);
    animateValue('average-profit-loss', data.average.profit_loss);
}
...
function animateValue(elementId, value) {
    ...
    // Tentukan apakah ini elemen profit/loss
    const isProfitLoss = elementId.toLowerCase().includes('profit-loss');
    
    // Set warna berdasarkan nilai jika ini profit/loss
    if (isProfitLoss) {
        if (value < 0) {
    ...
    // Format angka dengan tanda minus di depan jika negatif
